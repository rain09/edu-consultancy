...
if(isset($_GET['action'])){
  if($_GET['action']=='delete'){
    ...
    $deleteUniversity=$university->deleteUniversity($university_ID);
    if($deleteUniversity){
      $deleteMSg='<div class="alert alert-success" role="alert"> University name deleted successfully.</div>';
    }
 ...
 <table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="updateuniversities.php?university_ID=<?php echo  $value['uni_ID'];?>" class="btn btn-primary">Edit</a>  
      <td><a href="?action=delete&university_ID=<?php echo $value['uni_ID'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')"> Delete</a> 
