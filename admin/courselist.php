...
if(isset($_GET['action'])){
  if($_GET['action']=='delete'){
    ...
    $deleteCourses=$courses->deleteCourses($courses_ID);
    if($deleteCourses){
      $deleteMSg='<div class="alert alert-success" role="alert"> Courses name deleted successfully.</div>';
    }
 ...
 <table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="updatecourses.php?courses_ID=<?php echo  $value['courses_ID'];?>" class="btn btn-primary">Edit</a> 
      <td><a href="?action=delete&courses_ID=<?php echo $value['courses_ID'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')"> Delete</a> 
