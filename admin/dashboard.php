  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9" style="text-align:center;">
        ...
        <a href="addcourses.php"><button type="submit" class="btn-submit"><b>ADD COURSES</b></button>       
        <a href="adduniversities.php"><button type="submit" class="btn-submit"><b>ADD UNIVERSITIES</b></button>
        
 
 <a href="unicourse.php"><button type="submit" class="btn-submit"><b>ADD UNI_COURSE</b></button>
