...
<section id="content">
 ...
 <button type="submit" class="btn-submit"><b>INSERT COURSES</b></button>
 <button type="submit" class="btn-submit"><b>INSERT UNIVERSITIES' COURSES</b></button>
<div class="unilist">
  <a href="#"><p align="right"><i><u>Universities' List>></u></i></p></a>
</div>

 <section id="add">
  <form>
 <div class="addcollege">
      <p>Insert University/Colleges Name</p>
      <div class="textbox">
        <i class="fa fa-university" aria-hidden="true"></i>
        <input type="text" placeholder="Insert University Name" name="" value="">
      </div>
      <div class="textbox">
