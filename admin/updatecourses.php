...
$courses->getCoursesDetail($courses_ID);
if(isset($_POST['saveupdate'])){
  $coursesname=$_POST['coursesname'];
  $updateCourses=$courses->updateCourses($coursesname,$courses_ID);
  if($updateCourses){
    $UpdateMsg = '<div class="alert alert-success" role="alert"> Course Name updated successfully.</div>';
    $courses->getCoursesDetail($courses_ID);
  } 
}
?>
...
<div class="unilist">
 ...
 <table class="table table-striped">
  ...
  <tbody>
    <tr>
      <th scope="row"></th>
      <td><input type="text" class="form-control" name="coursesname" id="type" value="<?php echo $courses->coursename;?>"></td>
